        ...
        <fieldset>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <input class="form-control" name="gm_name" id="gm_name" type="text" readonly>
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <input class="form-control" name="gm_formatted_address" id="gm_formatted_address" type="text" readonly>
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        <div class="col-lg-3">
                                                <input class="form-control" name="gm_place_id" id="gm_place_id" type="hidden">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        <div class="col-lg-3">
                                                <input class="form-control" name="gm_lat" id="gm_lat" type="hidden">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                ...then complete the remaining information about your event.
                </div>
                <div class="row">
                        <div class="col-lg-2">
                                <p class="text-danger">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        <div class="col-lg-3">
                                                <input class="form-control" name="gm_lng" id="gm_lng" type="hidden">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <input class="form-control" name="title" id="title" placeholder="Event title" type="text" value="{{ old('title') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <input class="form-control" name="description" id="description" placeholder="Event description" type="text" value="{{ old('description') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <div class="radio">
                                                        <label>
                                                                <input name="eventType" id="eventType1" value="0" checked="" type="radio">
                                                                Recurring
                                                        </label>
                                                </div>
                                                <div class="radio">
                                                        <label>
                                                                <input name="eventType" id="eventType2" value="1" type="radio">
                                                                One-time
                                                        </label>
                                                </div>
                                        </div>
