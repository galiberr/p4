...
@section('content')
<form name="registerForm" id="registerForm" method='POST' action='/register' class="form-horizontal" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <fieldset>
                <div class="row">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <div class="radio">
                                                        <label>
                                                                <input name="inputUserType" id="inputUserType1" value="0" checked="" type="radio">
                                                                KJ
                                                        </label>
                                                </div>
                                                <div class="radio">
                                                        <label>
                                                                <input name="inputUserType" id="inputUserType2" value="1" type="radio">
                                                                Singer
                                                        </label>
                                                </div>
                                        </div>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="user_name" id="user_name" placeholder="User name" type="text" value="{{ old('user_name') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="email" id="email" placeholder="Your email address" type="text" value="{{ old('email') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="first_name" id="first_name" placeholder="Your first name" type="text" value="{{ old('first_name') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="last_name" id="last_name" placeholder="Your last name" type="text" value="{{ old('last_name') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="street_addr1" id="street_addr1" placeholder="Address line 1" type="text" value="{{ old('street_addr1') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="street_addr2" id="street_addr2" placeholder="Address line 2" type="text" value="{{ old('street_addr2') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                <input class="form-control" name="city" id="city" placeholder="City" type="text" value="{{ old('city') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                                <input class="form-control" name="state" id="state" placeholder="State" type="text" value="{{ old('state') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                                <input class="form-control" name="zip" id="zip" placeholder="Zip code" type="text" value="{{ old('zip') }}">
                                        </div>
                                </div>
                        </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-10">
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <textarea class="form-control" rows="3" name="about_me" id="about_me"  value="{{ old('about_me') }}"></textarea>
                                        </div>
                                </div>                
                        </div>
                </div>
